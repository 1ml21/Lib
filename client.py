...
class Client(Callbacks, SocketHandler):
    ...
    def LogHed(self, data: str = None):
    	return headers.LoginHeaders(data=data, deviceId=self.device_id).headers
    ...
    def login(self, email: str, password: str, clientType: int =100):
        ...
        **Returns**
        ...
        response = self.session.post(f"{self.api}/g/s/auth/login", headers=self.LogHed(data=data), data=data)
